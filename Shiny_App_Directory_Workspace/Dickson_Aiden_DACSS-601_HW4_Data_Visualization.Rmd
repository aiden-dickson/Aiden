...
---
## ------ HOMEWORK 3 SECTION -Introductory Tidying: ---------------
...
rsconnect::setAccountInfo(name='aidenflowers', token='C9B503D0A879598A1DD5EADDD40E2437', secret='SqcUO3uMQeQrw80FOVh+E5UoHOhxFs1Mb1U1tfKK')
...
# Is not displaying specified y-axis label
    ```
## ------HOMEWORK 4 SECTION -Visualization [and a little more tidying]: -----
...
## ------HOMEWORK 5 SECTION - Advancing Visualization [and Advancing Tidying]: -----


## Refinements made to former work after learning more:

- Edited code to load dataset so it will have *labels this time via haven's as_factor() function piped on the end of a read_sav() operation.  Before I just used mutate, thinking I was required to re-add labels this way.
   - Will ensure to keep category of answer 'Don't know and refused' in any 'mutate' per suggestion in various R projects, in forthcoming work.
   - Will be attempting to calculate summaries of the data that are now *weighted, to make sure estimates are representative of the population.
   

## In following will be attempting plot of x-tabs table with 3 demographic variables [Political View, Income and Level of Education] and a weighted estimate summing the percentage of a given category of answer 
